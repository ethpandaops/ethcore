...
func TestValidationResult(t *testing.T) {
	tests := []struct {
		...
		{ethpubsub.ValidationResult(99), "unknown"},
	}
...
func TestTopicScoreParams(t *testing.T) {
	params := &ethpubsub.TopicScoreParams{
		TopicWeight:                    0.5,
...
func TestDefaultTopicScoreParams(t *testing.T) {
	defaults := ethpubsub.DefaultTopicScoreParams()
...
func TestPeerScoreSnapshot(t *testing.T) {
	...
	snapshot := ethpubsub.PeerScoreSnapshot{
		PeerID:       peerID,
		Score:        0.8,
