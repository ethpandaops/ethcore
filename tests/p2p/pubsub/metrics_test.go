...
func TestMetricsRecordMethods(t *testing.T) {
	...
	metrics.RecordMessageValidated("test_topic", ethpubsub.ValidationAccept)
	metrics.RecordMessageValidated("test_topic", ethpubsub.ValidationReject)
...
func TestMetricsRecordMessageValidated(t *testing.T) {
	...
	metrics.RecordMessageValidated(topic, ethpubsub.ValidationAccept)
	metrics.RecordMessageValidated(topic, ethpubsub.ValidationReject)
	metrics.RecordMessageValidated(topic, ethpubsub.ValidationIgnore)
